...
type LoginError = { code: "invalid_credentials" } | { code: "server_error"; details?: unknown };

type RegisterError = { code: "user_already_exists" } | { code: "server_error"; details?: unknown };
