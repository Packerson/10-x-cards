...
export type CreateGenerationCommand = Pick<TablesInsert<"generations">, "prompt_text">;

export type GenerationCreatedDTO = Pick<GenerationEntity, "id" | "prompt_text" | "total_generated" | "status"> & {
...
export type GenerationsListResponseDTO = ListResponse<GenerationListItemDTO>;
...
export type GenerationErrorsListResponseDTO = ListResponse<GenerationErrorDTO>;

/**
 * --- Cards ---
 */
export type CardCreatePayload = Pick<TablesInsert<"cards">, "front" | "back" | "source" | "generation_id">;
...
export type CardDetailDTO = Pick<CardEntity, "id" | "front" | "back" | "source" | "created_at" | "updated_at">;

export type UpdateCardCommand = Pick<TablesUpdate<"cards">, "front" | "back">;
